...
btn_save = QPushButton("Сохранить")  # Новая кнопка для сохранения
btn_reset = QPushButton("Сбросить фильтры")  # Новая кнопка для сброса фильтров
...
btn_dir.clicked.connect(showFilnamesList)
btn_bw.clicked.connect(workimage.do_bow)
